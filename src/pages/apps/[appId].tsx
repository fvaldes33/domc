    ...
    <Page>
      ...
      <section className="p-4 flex flex-col">
        <header className="flex items-center">
          <div className="w-2/3 ">
            <span className="mb-1 px-2 py-1 bg-slate-200 text-slate-600 text-xs rounded-md capitalize">
              {app.tier_slug}
            </span>
        ...
        <div className="grid grid-cols-3 border rounded-lg divide-x mt-2">
          <div className="p-2">
      ...
      <div className="mb-6">
        ...
        <div className="flex justify-center my-4">
          <Link
            ...
            className="h-10 bg-indigo-100 rounded-md flex items-center justify-center text-indigo-600 px-6"
          >
            See All
          </Link>
        </div>
